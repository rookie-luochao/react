import { IPersonBasicInfo, IPersonOtherInfo } from "./interface";
...
export function displayPersonInfo(field: keyof IPersonBasicInfo | keyof IPersonOtherInfo) {
  return (
    displayPersonBasicInfo(field as keyof IPersonBasicInfo) || displayPersonOtherInfo(field as keyof IPersonOtherInfo)
  );
}
